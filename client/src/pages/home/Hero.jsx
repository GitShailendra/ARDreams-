        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center bg-[#FFD700]/10 rounded-full px-4 py-2 space-x-2">
              ...
              <span className="text-[#FFD700] font-semibold">Season 1 Live Now</span>
            </div>

            {/* Main Heading */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-gradient-to-r from-[#F7A31C] to-[#FFD700] text-white px-8 py-4 rounded-full font-medium hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center group">
                Start Your Journey
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="bg-white/10 text-white px-8 py-4 rounded-full font-medium hover:bg-white/20 transition-all duration-200 flex items-center justify-center">
                View Prize Calendar
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-[#F7A31C]">20+</div>
                <div className="text-sm text-gray-400">Major Prizes</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-[#F7A31C]">₹1000</div>
                <div className="text-sm text-gray-400">Monthly</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-[#F7A31C]">25+</div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-[#1F2937]/50 to-[#2C3E50]/50 rounded-2xl p-6 backdrop-blur-xl border border-white/10">
              {/* Current Prize Display */}
              <div className="text-center mb-6">
                <h3 className="text-[#F7A31C] font-semibold mb-2">Current Month's Prize</h3>
                <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-4">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                    <div className="text-white text-left">
                      <h4 className="text-xl font-bold">Tata Tiago Car</h4>
                      <p className="text-sm">Worth ₹6,00,000</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {additionalPrizes.map((prize) => (
                  <div key={prize.name} className="group bg-white/5 rounded-lg p-3 text-center hover:bg-white/10 transition-colors cursor-pointer">
              ...
              {/* Live Draw Info */}
              <div className="mt-6 bg-[#F7A31C]/10 rounded-lg p-4 flex items-center justify-between">
                <div className="flex items-center">
                  <Users className="w-5 h-5 text-[#F7A31C] mr-2" />
                  <span className="text-sm text-white">Next Draw:</span>
                </div>
                <div className="text-[#F7A31C] font-semibold">10th February</div>
              </div>
            </div>
          </div>
        </div>
